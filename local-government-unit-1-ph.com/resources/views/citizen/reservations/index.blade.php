        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('citizen.reservations', ['status' => 'cancelled', 'search' => $search]) }}" 
                       class="px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-sm hover:shadow-md cursor-pointer {{ $status === 'cancelled' ? 'bg-lgu-button text-lgu-button-text shadow-lg scale-105' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="inline-block mr-1">
                            <path d="M18 6 6 18"/><path d="m6 6 12 12"/>
                        </svg>
                        Cancelled <span class="ml-1 px-2 py-0.5 bg-white/30 rounded-full text-xs">{{ $statusCounts['cancelled'] }}</span>
                    </a>
                </div>
            </div>
        </div>
