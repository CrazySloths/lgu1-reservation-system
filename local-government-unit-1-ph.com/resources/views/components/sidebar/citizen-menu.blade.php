...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="{{ route('citizen.dashboard') }}" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200">
        ...
        <li>
            <a href="{{ route('citizen.browse-facilities') }}" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200">
                <svg class="w-5 h-5 mr-gr-xs" fill="currentColor" viewBox="0 0 20 20">
        ...
        <li>
            <a href="{{ route('citizen.facility-calendar') }}" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200">
                <svg class="w-5 h-5 mr-gr-xs" fill="currentColor" viewBox="0 0 20 20">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="{{ route('citizen.reservations') }}" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200">
                <svg class="w-5 h-5 mr-gr-xs" fill="currentColor" viewBox="0 0 20 20">
        ...
        <li>
            <a href="{{ route('citizen.reservation.history') }}" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200">
                <svg class="w-5 h-5 mr-gr-xs" fill="currentColor" viewBox="0 0 20 20">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="{{ route('citizen.payment-slips') }}" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="{{ route('citizen.bulletin') }}" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="{{ route('citizen.profile') }}" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200">
                <svg class="w-5 h-5 mr-gr-xs" fill="currentColor" viewBox="0 0 20 20">
