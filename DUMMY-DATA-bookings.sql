...
(NULL, 'City Mayor Office', 3, 'City Mayor Office', 'mayor@lgu1.gov.ph', '09121234567', 'City Hall', 'Community Forum', 'Monthly Community Town Hall Meeting', '2025-10-25', '14:00:00', '17:00:00', 150, 0.00, 'approved', 'Priority city event', '2025-10-13 09:00:00', '2025-10-13 10:00:00'),
(NULL, 'Ana Garcia', 2, 'Ana Garcia', 'ana@example.com', '09161234567', '321 Maple St, City', 'Youth Sports Clinic', 'Free basketball coaching for youth', '2025-10-27', '08:00:00', '12:00:00', 30, 800.00, 'approved', NULL, '2025-10-14 11:00:00', '2025-10-14 11:00:00'),
...
(NULL, 'Barangay Office', 2, 'Barangay Office', 'brgy@example.com', '09182233445', 'Barangay Hall', 'Community Sports Day', 'Barangay sports activities', '2025-11-12', '06:00:00', '17:00:00', 150, 1500.00, 'approved', NULL, '2025-10-18 09:00:00', '2025-10-18 09:00:00'),

-- More future bookings (mid-November)
(NULL, 'Michael Torres', 3, 'Michael Torres', 'michael@example.com', '09193344556', '222 Oak St, City', 'Training Workshop', 'IT Skills Development', '2025-11-15', '08:00:00', '17:00:00', 40, 1900.00, 'approved', NULL, '2025-10-19 11:00:00', '2025-10-19 11:00:00'),
(NULL, 'Sofia Martinez', 1, 'Sofia Martinez', 'sofia@example.com', '09164455667', '333 Pine St, City', 'Engagement Party', 'Engagement celebration', '2025-11-17', '18:00:00', '23:00:00', 90, 2200.00, 'approved', NULL, '2025-10-20 14:00:00', '2025-10-20 14:00:00'),
(NULL, 'Youth Organization', 2, 'Youth Organization', 'youth@example.com', '09175566778', '444 Maple Ave, City', 'Dance Competition', 'Regional dance contest', '2025-11-20', '10:00:00', '19:00:00', 100, 2000.00, 'approved', NULL, '2025-10-21 10:00:00', '2025-10-21 10:00:00'),
(NULL, 'Business Chamber', 3, 'Business Chamber', 'chamber@example.com', '09186677889', '555 Cedar Rd, City', 'Networking Event', 'Business networking night', '2025-11-22', '17:00:00', '21:00:00', 60, 1600.00, 'approved', NULL, '2025-10-21 15:00:00', '2025-10-21 15:00:00'),

-- Late November bookings
(NULL, 'Linda Garcia', 1, 'Linda Garcia', 'linda@example.com', '09197788990', '666 Birch Ln, City', 'Charity Event', 'Fundraising gala', '2025-11-25', '16:00:00', '22:00:00', 140, 2800.00, 'approved', NULL, '2025-10-22 09:00:00', '2025-10-22 09:00:00'),
(NULL, 'School District', 2, 'School District', 'school@example.com', '09168899001', '777 Elm Ave, City', 'Sports Tournament', 'Inter-school basketball', '2025-11-27', '08:00:00', '18:00:00', 180, 2000.00, 'approved', NULL, '2025-10-22 11:00:00', '2025-10-22 11:00:00');
