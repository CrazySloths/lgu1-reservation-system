...
<body>
    ...
    <div class="lg:ml-64 min-h-screen">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        <button class="p-3 text-gray-700 hover:text-lgu-highlight relative bg-gray-100 rounded-xl hover:bg-gray-200 transition-all">
                            ...
                            <span class="absolute -top-1 -right-1 bg-lgu-tertiary text-white text-xs rounded-full h-5 w-5 flex items-center justify-center shadow-lg animate-bounce">2</span>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <main class="p-4 lg:p-6 bg-lgu-bg min-h-screen">
            @yield('content')
        </main>
    </div>
