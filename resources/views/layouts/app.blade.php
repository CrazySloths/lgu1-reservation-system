...
<body>
    ...
    <div class="lg:ml-64 min-h-screen">
        <header class="bg-white shadow-sm border-b border-fray-200 sticky top-0 z-40">
            <div class="flex items-center justify-between justify-between px-4 py-3">
                <div class="flex items-center space-x-5">
                    <button id="mobile-sidebar-toggle" class="lg:hidden text-lgu-headline hover:text-lgu-highlihgt mr-3">
