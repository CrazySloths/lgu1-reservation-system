            ...
            <div class="flex items-center justify-between px-4 py-3">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:block relative">
                        <input type="text" 
                               placeholder="Search..." 
                               class="w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-lgu-highlight focus:border-transparent">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="hidden md:block">
                            <p class="text-sm font-medium text-lgu-headline">Admin Name</p>
