    ...
    <div class="bg-white shadow rounded-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">View your reservation history and status</p>
            </div>
    ...
    <div class="bg-white shadow rounded-lg">
        @if($reservations->count() > 0)
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="grid grid-cols-6 gap-4 text-sm font-medium text-gray-700">
                    <div>Facility</div>
                    <div>Event</div>
                    <div>Date & Time</div>
                    <div>Status</div>
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="px-6 py-4 hover:bg-gray-50">
                    <div class="grid grid-cols-6 gap-4 items-center">
                        <!-- Facility -->
                        <div>
                            <h4 class="font-medium text-gray-900">{{ $reservation->facility_name ?? 'N/A' }}</h4>
                            <p class="text-sm text-gray-600">{{ $reservation->facility_location ?? '' }}</p>
                        </div>
