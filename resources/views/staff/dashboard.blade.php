...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all hover:scale-105">
        ...
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all hover:scale-105">
            <div class="flex items-center">
                <div class="flex-shrink-0">
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-100 border border-green-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all hover:scale-105">
            <div class="flex items-center">
                <div class="flex-shrink-0">
        ...
        <div class="bg-gradient-to-br from-yellow-50 to-amber-100 border border-yellow-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all hover:scale-105">
            <div class="flex items-center">
                <div class="flex-shrink-0">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('staff.verification.index') }}" class="text-sm text-lgu-highlight hover:text-lgu-headline font-medium">
                        View All →
                    </a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('staff.stats') }}" class="text-sm text-lgu-highlight hover:text-lgu-headline font-medium">
                        View Stats →
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('staff.verification.index') }}" 
               class="flex items-center p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-lgu-highlight hover:bg-lgu-bg/50 transition-all">
            ...
            <a href="#" class="flex items-center p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-lgu-highlight hover:bg-lgu-bg/50 transition-all">
                <svg class="w-8 h-8 text-lgu-highlight mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
