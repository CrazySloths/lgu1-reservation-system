    ...
    <div class="bg-lgu-headline rounded-2xl p-6 text-white shadow-lgu-lg overflow-hidden relative">
        ...
        <div class="relative z-10 flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-3xl font-bold mb-1 bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent">Maintenance Log #{{ $maintenanceLog->id }}</h1>
                    <p class="text-gray-200">{{ $maintenanceLog->facility->name ?? 'N/A' }}</p>
                </div>
            </div>
