...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-lgu-headline to-lgu-stroke rounded-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2">LGU Admin Dashboard</h1>
                <p class="text-gray-200">South Caloocan City General Services Department</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-red-50 border border-red-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-red-800">Pending Approvals</p>
                    <p class="text-2xl font-bold text-red-900">{{ $pendingApprovalsCount }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-orange-800">Schedule Conflicts</p>
                    <p class="text-2xl font-bold text-orange-900">{{ $conflicts->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-yellow-800">Overdue Payments</p>
                    <p class="text-2xl font-bold text-yellow-900">{{ $overduePayments->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-green-800">Today's Events</p>
                    <p class="text-2xl font-bold text-green-900">{{ \App\Models\Booking::approved()->whereDate('event_date', now())->count() }}</p>
                </div>
            </div>
        </div>
    </div>
